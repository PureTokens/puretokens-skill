...
Reviewed 2026-09-16. Public source: the production console's
`/api/product/docs/model-catalog`. This is selection metadata, not authenticated
model access or paid generation proof.

- Image 2.5 Flare and Sunburst: add `3:1` and `1:3`, and remove `4:5` and
  `5:4` from the aspect-ratio enums for generation and editing. Image 2 keeps
  its existing ratios; do not apply the Image 2.5 change to other models.
