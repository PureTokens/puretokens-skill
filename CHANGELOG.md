...
- Added copyable, terminal-Agent installation prompts for the Windows Codex test flow and Claude Code/Gemini CLI. They validate the repository, upgrade only managed same-name Skills, preserve unrelated directories, and prohibit credential or host-configuration access.
